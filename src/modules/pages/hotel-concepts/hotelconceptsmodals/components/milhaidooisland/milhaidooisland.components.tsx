...
import * as styles from './milhaidooisland.scss';
import { MapsModalData } from './milhaidooisland.hook';
import { useTranslation } from 'react-i18next';

/**
 * Renders MilhaidooLslandModal
 */
const MilhaidooLslandModal = () => {
  ...
  return (
    <>
      ...
      <div className={styles.mapsmodal}>
        <img src={`img/MilhaidooIsland.png  `} className={styles.modelImg} />
        <div className={styles.hotelDescription}>
          <h1 className={styles.hotelDescriptionHeading}>
            {t(
              'hotel-concepts.about-maps-modals-data.maps-modal1.milhaidoo-island.title'
            )}
          </h1>
          <p className={styles.hotelDescriptionPara}>
            {t(
              'hotel-concepts.about-maps-modals-data.maps-modal1.milhaidoo-island.discription'
            )}
          </p>
          <p className={styles.hotelDescriptionHashTag}>
            {t(
              'hotel-concepts.about-maps-modals-data.maps-modal1.milhaidoo-island.hash-tag'
            )}
          </p>
      ...
      <div className={styles.aboutHotel}>
        <div className={styles.aboutHotelDesign}>
          <p className={styles.aboutHotelDetailsLabal}>
            {t(
              'hotel-concepts.about-maps-modals-data.maps-modal1.milhaidoo-island.about.achievments.title'
            )}
          </p>
        ...
        <div className={styles.hotelDescriptionList}>
          <ul className={styles.hotelDescriptionListUl}>
            <h2>
              {t(
                'hotel-concepts.about-maps-modals-data.maps-modal1.milhaidoo-island.about.awards.title'
              )}
            </h2>
            {awards.map((item, id) => (
              <li key={id}>
