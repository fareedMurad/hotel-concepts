...
import { MapsModalData } from './feldererboutiquehotel.hook';
import { useTranslation } from 'react-i18next';

/**
 * Renders FeldererBoutiqueHotel
 */
const FeldererBoutiqueHotel = () => {
  ...
  return (
    <>
      ...
      <div className={styles.mapsmodal}>
        <img src={`img/Felderer.png  `} className={styles.modelImg} />
        <div className={styles.hotelDescription}>
          <h1 className={styles.hotelDescriptionHeading}>
            {t(
              'hotel-concepts.about-maps-modals-data.maps-modal1.felderer-boutique-hotel.title'
            )}
          </h1>
          <p className={styles.hotelDescriptionPara}>
            {t(
              'hotel-concepts.about-maps-modals-data.maps-modal1.felderer-boutique-hotel.discription'
            )}
          </p>
          <p className={styles.hotelDescriptionHashTag}>
            {t(
              'hotel-concepts.about-maps-modals-data.maps-modal1.felderer-boutique-hotel.hash-tag'
            )}
          </p>
      ...
      <div className={styles.hotelDescriptionList}>
        <ul className={styles.hotelDescriptionListUl}>
          <h2>
            {t(
              'hotel-concepts.about-maps-modals-data.maps-modal1.felderer-boutique-hotel.about.awards.title'
            )}
          </h2>
          {awards.map((item, id) => (
            <li key={id}>
      ...
      <div className={styles.aboutHotelDesign}>
        <p className={styles.aboutHotelDetailsLabal}>
          {t(
            'hotel-concepts.about-maps-modals-data.maps-modal1.felderer-boutique-hotel.about.achievments.title'
          )}
        </p>
