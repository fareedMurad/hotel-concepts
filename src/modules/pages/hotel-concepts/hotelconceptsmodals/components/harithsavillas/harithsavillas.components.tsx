...
import * as styles from './harithsavillas.scss';
import { MapsModalData } from './harithsavillas.hook';
import { useTranslation } from 'react-i18next';

/**
 * Renders HarithsaVillasModal
 */
const HarithsaVillasModal = () => {
      ...
      <div className={styles.mapsmodal}>
        ...
        <div className={styles.hotelDescription}>
          <h1 className={styles.hotelDescriptionHeading}>
            {t(
              'hotel-concepts.about-maps-modals-data.maps-modal1.haritha-villas.title'
            )}
          </h1>
          <p className={styles.hotelDescriptionPara}>
            {t(
              'hotel-concepts.about-maps-modals-data.maps-modal1.haritha-villas.discription'
            )}
          </p>
          <p className={styles.hotelDescriptionHashTag}>
            {t(
              'hotel-concepts.about-maps-modals-data.maps-modal1.haritha-villas.hash-tag'
            )}
          </p>
      ...
      <div className={styles.aboutHotel}>
        <div className={styles.aboutHotelDesign}>
          <p className={styles.aboutHotelDetailsLabal}>
            {t(
              'hotel-concepts.about-maps-modals-data.maps-modal1.haritha-villas.about.achievments.title'
            )}
          </p>
        ...
        <div className={styles.hotelDescriptionList}>
          <ul className={styles.hotelDescriptionListUl}>
            <h2>
              {t(
                'hotel-concepts.about-maps-modals-data.maps-modal1.haritha-villas.about.awards.title'
              )}
            </h2>
            {awards.map((item, id) => (
              <li key={id}>
