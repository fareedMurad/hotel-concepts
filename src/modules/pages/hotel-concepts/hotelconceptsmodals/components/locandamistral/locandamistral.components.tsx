...
import * as styles from './locandamistral.scss';
import { MapsModalData } from './locandamistral.hook';
import { useTranslation } from 'react-i18next';

/**
 * Renders LocandaMistralModal
 */
const LocandaMistralModal = () => {
  ...
  return (
    <>
      ...
      <div className={styles.mapsmodal}>
        <img src={`img/LocandaMistral.png  `} className={styles.modelImg} />
        <div className={styles.hotelDescription}>
          <h1 className={styles.hotelDescriptionHeading}>
            {t(
              'hotel-concepts.about-maps-modals-data.maps-modal1.locanda-mistral.title'
            )}
          </h1>
          <p className={styles.hotelDescriptionPara}>
            {t(
              'hotel-concepts.about-maps-modals-data.maps-modal1.locanda-mistral.discription'
            )}
          </p>
          <p className={styles.hotelDescriptionHashTag}>
            {t(
              'hotel-concepts.about-maps-modals-data.maps-modal1.locanda-mistral.hash-tag'
            )}
          </p>
      ...
      <div className={styles.aboutHotel}>
        <div className={styles.aboutHotelDesign}>
          <p className={styles.aboutHotelDetailsLabal}>
            {t(
              'hotel-concepts.about-maps-modals-data.maps-modal1.locanda-mistral.about.achievments.title'
            )}
          </p>
        ...
        <div className={styles.hotelDescriptionList}>
          <ul className={styles.hotelDescriptionListUl}>
            <h2>
              {t(
                'hotel-concepts.about-maps-modals-data.maps-modal1.locanda-mistral.about.awards.title'
              )}
            </h2>
            {awards.map((item, id) => (
              <li key={id}>
