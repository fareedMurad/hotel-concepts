  ...
  const programs = [
    {
      ...
      description: "develop in-depth expertise in areas that are critical for you",
      path: "/programs-catalogue/focused-programs"
    },
    {
      name: "Digital Transformation",
      description: "use exponentially improving technologies to transform your hospitality business",
